...
\setCJKsansfont[AutoFakeBold]{LXGW WenKai} % 设置中文无衬线字体 / Set Chinese sans-serif font
\setCJKmainfont{LXGW WenKai} % 设置中文衬线字体 / Set Chinese serif font
\setCJKmonofont{Sarasa Mono SC} % 设置中文等宽字体 / Set Chinese monospaced font
\setmainfont{Times New Roman} % 设置主字体 / Set main font

% 参考文献 / References
\usepackage[citestyle=authoryear, backend=biber]{biblatex} % 参考文献管理 / Bibliography management
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.1\linewidth]{pic/SDU.eps}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{itemize}
        ...
        \newline
        \item 基于SDU-Beamer-Theme，作出的修改有：
            \begin{itemize}
